...
run_action "build" "action" "/nix/store/6m0gfhk5gdwwa9dvxhgw886wjw0gc35b-action/bin/action" 'success()' 'date +%s%N 2>/dev/null || echo "0"'
...
run_action "build" "build-image" "/nix/store/dcazyc5wh2xf9crfpvjm7vrhkzzslikq-build-image/bin/build-image" 'success()' 'date +%s%N 2>/dev/null || echo "0"'
...
run_action "lint" "action" "/nix/store/6m0gfhk5gdwwa9dvxhgw886wjw0gc35b-action/bin/action" 'success()' 'date +%s%N 2>/dev/null || echo "0"'
...
run_action "lint" "lint" "/nix/store/amb4i5hgxyja2dp5hkj7c9jqy5dm0gxf-lint/bin/lint" 'success()' 'date +%s%N 2>/dev/null || echo "0"'
...
run_action "test" "action" "/nix/store/6m0gfhk5gdwwa9dvxhgw886wjw0gc35b-action/bin/action" 'success()' 'date +%s%N 2>/dev/null || echo "0"'
...
run_action "test" "install-and-test" "/nix/store/drzbv04yg3bda6flcb90iq0831i6fi1g-install-and-test/bin/install-and-test" 'success()' 'date +%s%N 2>/dev/null || echo "0"'
